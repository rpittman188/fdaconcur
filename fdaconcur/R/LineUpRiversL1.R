LineUpRiversL1<-function(MainRiver, NewCurve){
  ...
  absdiff<-abs(samesize.NewCurve - MainRiver$CongHt)
  ...
  for(i in 1:50000){ #50,000 is an arbitrarily high number.
    ...
    if(upper.index-lower.index<10) break #Could be a bigger number than 10. just says to stop if we are not taking much of the new curve. With floods, 10 could mean 2.5hours. No way we need to go less than that. (15 minutes intervals)
  }
